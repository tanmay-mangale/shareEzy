  ...
  return (
    <div className="h-screen flex justify-center items-center bg-black">
      ...
      >
        ...
        <h2 className="mt-4 text-3xl font-bold" id="roomId">{roomId}</h2>
        <button id="copyBtn" onClick={()=>copyId("roomId")} className="mt-4 px-15 text-xl font-bold py-3 bg-green-400 rounded-2xl">
          {btnText}
        </button>
        <br />
        <ThreeDots
